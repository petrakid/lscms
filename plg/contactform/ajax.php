...
if(isset($_POST['sformdata'])) {
     ...
     $sql = $db->query("SELECT * FROM $_SESSION[prefix]_contactform WHERE f_id = $_POST[sform_id]");
     ...
     switch($frm['send_type']) {
          ...
          case 2:
               ...
               $sql = $db->exec("INSERT INTO $_SESSION[prefix]_contactform_data (`sub_date`, `sub_data`) VALUES (now(), '$data')");
...
if(isset($_POST['form_id'])) {
     $db->exec("UPDATE $_SESSION[prefix]_contactform SET form_data = ". $db->quote($_POST['formdata']) ." WHERE f_id = '$_POST[form_id]'");
...
if(isset($_POST['form_settings'] )) {
     $sql = $db->query("SELECT * FROM $_SESSION[prefix]_contactform WHERE page_id = $_POST[pg_id]");
     $frm = $sql->fetch(PDO::FETCH_ASSOC);
     ?>
...
if(isset($_POST['save_options'])) {
     ...
     $cnt = 0;
     $sql = "UPDATE $_SESSION[prefix]_contactform SET ";
