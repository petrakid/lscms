...
if($bio->rowCount() != 0) {
     while($b = $bio->fetch(PDO::FETCH_ASSOC)) {
          ...
          if($b['calendly_link'] > '') {
               ?>
               <a href="<?php echo $b['calendly_link'] ?>" target="_blank" type="button" class="btn-floating btn-small btn-cyan" title="Schedule a Meeting"><i class="far fa-calendar-alt"></i></a>
