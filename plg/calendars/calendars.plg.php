...
if(!isset($_GET['eventid'])) {
     ...
     function showResult(str) {
          ...
          xmlhttp.open("GET","<?php echo $gbl['site_url'] ?>/plg/calendars/ajax.php?q=" + str, true);
          xmlhttp.send();
     }
     </script>
     <?php 
               ...
               $.ajax({
                    ...
                    success: function(data) {
                         ...
                         $('#modalSave').on("click", function() {
                              ...
                              formdata.append('event_pinned', pinned);
                              formdata.append('email_event', $("input[name='email_event']:checked").val());
                              formdata.append('email_advance', $('#email_advance').val());
                              $.ajax({
                                   url: '<?php echo $gbl['site_url'] ?>/plg/calendars/ajax.php',
                                   type: 'POST',
                                   processData: false,
